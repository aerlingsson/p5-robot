...
class Saver:
    ...
    def append_epoch(self, epoch, time_avg, score_avg, agent_epsilon, agent_memory_size):
        self.results.append((epoch, time_avg, score_avg, agent_epsilon, agent_memory_size))

    '''
    def write_file(self):
        with open(self.filename + self.extension, 'w', newline='') as csvfile:
            writer = csv.DictWriter(csvfile, fieldnames= self.fieldnames_setup)
            writer.writeheader()
            writer.writerow({'Model_id' : self.model_id, 
                            'Save_interval' : self.save_interval, 
            ...
            for elem in self.results:
                epoch, time_avg, score_avg, agent_epsilon, agent_memory_size = elem
