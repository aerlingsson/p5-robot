...
public class Imgproc {
    ...
    /**
     * activity_main function for all demosaicing processes
     *
     ...
     * @param axes Half of the size of the ellipse activity_main axes.
     ...
     * @param axes Half of the size of the ellipse activity_main axes. See #ellipse for details.
